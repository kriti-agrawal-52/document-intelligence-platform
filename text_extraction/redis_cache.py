...
async def connect_to_redis():
    ...
    if not redis_host or not redis_port:
        print("REDIS_HOST or REDIS_PORT environment variables not set. Cache is disabled.")
        return
...
async def cache_user_recent_extractions_list(user_id: int, extraction_list: list, ttl: int = 86400):
    """
