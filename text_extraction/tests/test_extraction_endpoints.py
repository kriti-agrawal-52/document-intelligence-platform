...
with patch('text_extraction.main.connect_to_mongo'), \
     patch('text_extraction.main.connect_to_redis'), \
...
class TestTextExtractionEndpoints:
    ...
    def test_get_documents_empty_list(self, mock_collection, mock_verify_token, client, auth_headers):
        ...
        mock_collection.return_value.find.return_value.sort.return_value.skip.return_value.limit.return_value = mock_cursor
    ...
    @patch('shared.auth_utils.verify_token')
    @patch('text_extraction.main.get_extracted_texts_collection')
    def test_get_documents_with_data(self, mock_collection, mock_verify_token, client, auth_headers):
    ...
    @patch('shared.auth_utils.verify_token')
    @patch('text_extraction.main.get_extracted_texts_collection')
    def test_get_document_by_name_not_found(self, mock_collection, mock_verify_token, client, auth_headers):
    ...
    @patch('shared.auth_utils.verify_token')
    @patch('text_extraction.main.get_extracted_texts_collection')
    def test_get_document_by_name_success(self, mock_collection, mock_verify_token, client, auth_headers):
    ...
    def test_extract_text_success(self, mock_cache, mock_sqs, mock_s3, mock_openai, 
                                 mock_collection, mock_verify_token, client, auth_headers):
    ...
    @patch('shared.auth_utils.verify_token')
    def test_extract_text_invalid_file_type(self, mock_verify_token, client, auth_headers):
    ...
    @patch('shared.auth_utils.verify_token')
    @patch('text_extraction.main.get_extracted_texts_collection')
    def test_extract_text_duplicate_name(self, mock_collection, mock_verify_token, client, auth_headers):
        """Test text extraction with duplicate document name."""
        # Mock authentication
        mock_verify_token.return_value = 123
        
        # Mock existing document
        mock_collection.return_value.find_one.return_value = {"image_name": "test_document"}
