...
with patch('text_summarization.main.mongo_client'), \
     patch('text_summarization.main.openai_client'), \
     patch('text_summarization.main.sqs_client'):
    from text_summarization.main import app, process_message, SQSMessageBody
...
class TestSummarizationService:
    ...
    async def test_process_message_success(self, mock_sqs, mock_db, mock_openai):
        ...
        mock_openai_response.choices[0].message.content = "This is a summary of the text."
