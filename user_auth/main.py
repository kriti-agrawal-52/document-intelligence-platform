...
from shared.jwt_blacklist import init_jwt_blacklist_redis, close_jwt_blacklist_redis, blacklist_token
from shared.config import get_config

from datetime import timedelta # ADD THIS LINE! Or add it to an existing datetime import

from user_auth.models import SessionLocal, create_db_tables, User
from user_auth.schemas import UserCreate, UserOut, UserProfileUpdate, PasswordChangeRequest, UserProfileResponse
...
async def login_for_access_token(
    ...
    access_token_expires = timedelta(minutes=config_data.jwt.access_token_expire_minutes)
...
@app.post(
    auth_service_config.base_path + "/users/me/change-password",
    tags=["Users"]
)
