...
oauth2_scheme = OAuth2PasswordBearer(tokenUrl=f"{config.services.auth_service.base_path}/token")
...
if __name__ == "__main__":
    ...
    print(f"Verify 'mysecretpassword': {verify_password('mysecretpassword', hashed_pw)}")
